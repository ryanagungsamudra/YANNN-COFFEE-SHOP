                ...
                <div className='row add-product-content'>
                    ...
                    <div className='col col-md-6'>
                        ...
                        <div className='form-group'>
                            ...
                            <select name='category' id='category' className='form-control add-product-input' placeholder='Select category'
                        ...
                        <div className='form-group'>
                            ...
                            <div className="row">
                                <div className="col" style={{ marginLeft: '100px', marginTop: '6px' }}>
                                    <a href="/addproducts"><img src={small} style={{ width: '55px', height: '55px' }} alt="" /></a>
                                </div>
                                <div className="col">
                                    <a href="/addproducts"><img src={large} style={{ width: '55px', height: '55px', marginTop: '6px' }} alt="" /></a>
                                </div>
                                <div className="col" style={{ marginRight: '120px' }}>
                                    <a href="/addproducts"><img src={extraLarge} style={{ width: '55px', height: '55px', marginTop: '6px' }} alt="" /></a>
                                </div>
                            </div>
                        </div>
                        <div className='form-group'>
