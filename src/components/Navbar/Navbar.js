      ...
      <div className="container Navbar">
        ...
        <div className={`nav-items ${isOpen && "open"}`}>
          ...
          <div className="auth-nav-items-mobile mx-auto">
            <Link to="/login" className="d-block d-lg-none btn btn-primary login-mobile mb-2 py-2 ">Login</Link>
            <Link to="/signup" className="d-block d-lg-none btn btn-warning signup-mobile py-2 ">Sign Up</Link>
          </div>
        </div>
